...
import { useConsultas, useConsultasEnProceso } from '@/hooks/useConsultas';
import { ConsultaCard } from '@/components/consultas/ConsultaCard';
import { Button } from '@/components/ui/button';
import { Plus, Search, Activity } from 'lucide-react';
import type { EstadoConsulta } from '@/types/consulta';
import { cn } from '@/lib/utils';

const FILTROS: { label: string; valor: EstadoConsulta | 'todas' }[] = [
...
export default function ConsultasPage() {
  ...
  const { consultas, cargando } = useConsultas(
