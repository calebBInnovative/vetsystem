...
import { APPOINTMENT_TYPES, APPOINTMENT_DURATIONS, type AppointmentType } from '@/types/appointment';
          ...
          <div className="px-6 py-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-4 gap-2">
                {(Object.entries(APPOINTMENT_TYPES) as [AppointmentType, { label: string; emoji: string }][]).map(([key, info]) => (
                  <button
                    key={key}
                    type="button"
                    onClick={() => setTipo(key)}
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {APPOINTMENT_DURATIONS.slice(0, 5).map(({ value, label }) => (
                  <button
                    key={value}
                    type="button"
            ...
            <div className="flex gap-2 pb-1">
              <Button variant="outline" className="flex-1" onClick={handleCerrar} disabled={loading}>
                Cancelar
              </Button>
              <Button className="flex-1 gap-2" onClick={handleAgendar} disabled={loading || !fecha}>
